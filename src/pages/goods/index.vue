...
const nowSwiper = ref(0)

const getSwiperIndex: UniHelper.SwiperOnChange = (e) => {
  nowSwiper.value = e.detail.current
}
...
<template>
  <scroll-view scroll-y class="viewport">
    ...
    <view class="goods">
      <!-- 商品主图 -->
      <view class="preview">
        <swiper circular :current="nowSwiper" @change="getSwiperIndex">
          <swiper-item
        ...
        <view class="indicator">
          <text class="current">{{ nowSwiper + 1 }}</text>
